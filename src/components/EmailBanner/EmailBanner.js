...
function EmailBanner() {
  return (
    <div className="w-full block lg:block xl:flex xl:justify-between rounded-none shadow-lg bg-white px-6 py-8 my-4">
      ...
      <div className="flex w-5/12">
        <div className="shadow-xl bg-white focus:outline-none focus:shadow-outline border border-gray-400 rounded-none w-full">
          <svg className="w-10 h-12 inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#808080">
